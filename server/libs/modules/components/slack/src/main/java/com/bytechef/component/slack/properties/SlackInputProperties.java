...
public class SlackInputProperties {
    ...
    public static final Property
        CONTENT_TYPE_PROPERTY = string(CONTENT_TYPE)
            .label("Content type")
            .description("" +
    ...
    private static List<? extends Property.ValueProperty<?>> getEventTypeProperties(
        Parameters inputParameters, Parameters connectionParameters, ActionContext context) {

        return switch (inputParameters.getString(CONTENT_TYPE)){
