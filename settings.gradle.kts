...
include("ee:server:libs:automation:automation-configuration:automation-configuration-remote-rest")
include("ee:server:libs:automation:automation-configuration:automation-configuration-remote-client")
...
include("ee:server:libs:embedded:embedded-configuration:embedded-configuration-remote-client")
include("ee:server:libs:embedded:embedded-configuration:embedded-configuration-remote-rest")
include("ee:server:libs:platform:platform-component:platform-component-registry:platform-component-registry-remote-client")
include("ee:server:libs:platform:platform-component:platform-component-registry:platform-component-registry-remote-rest")
include("ee:server:libs:platform:platform-configuration:platform-configuration-remote-client")
include("ee:server:libs:platform:platform-configuration:platform-configuration-remote-rest")
include("ee:server:libs:platform:platform-connection:platform-connection-remote-client")
include("ee:server:libs:platform:platform-connection:platform-connection-remote-rest")
include("ee:server:libs:platform:platform-scheduler:platform-scheduler-remote-rest")
include("ee:server:libs:platform:platform-scheduler:platform-scheduler-remote-client")
include("ee:server:libs:platform:platform-workflow:platform-workflow-task-dispatcher:platform-workflow-task-dispatcher-registry:platform-workflow-task-dispatcher-registry-remote-client")
